...
def get_holiday_name(heb_day_int, heb_month_int, is_leap_year):
    HOLIDAYS = {
        (1, 1): "ראש השנה", (2, 1): "שני של ראש השנה", (10, 1): "יום כיפור",
        (15, 1): "ראשון של סוכות", (22, 1): "שמיני עצרת",
...
def get_lite_holiday_name(heb_day_int, heb_month_int, is_leap_year, is_kislev_29):
    LITE_HOLIDAYS = {
        (16, 1): "א דחול המועד סוכות", (17, 1): "ב דחול המועד סוכות",
        (18, 1): "ג דחול המועד סוכות", (19, 1): "ד דחול המועד סוכות",
        (20, 1): "ה דחול המועד סוכות", (21, 1): "הושענה רבא",
        (25, 3): "נר ראשון של חנוכה", (26, 3): "נר שני של חנוכה",
        (27, 3): "נר שלישי של חנוכה", (28, 3): "נר רביעי של חנוכה",
        ...
        (3, 1): "צום גדליה", (10, 4): "צום עשרה בטבת", 
...
def heb_month_names(number, is_leap=False):
    d={
        1:"תשרי", 2:"מרחשוון", 3:"כסלו", 4:"טבת", 5:"שבט",
...
def heb_month_day_names(number):
    d={1:"א",2:"ב",3:"ג",4:"ד",5:"ה",6:"ו",7:"ז",8:"ח",9:"ט",10:"י",
       11:"יא",12:"יב",13:"יג",14:"יד",15:"טו",16:"טז",17:"יז",18:"יח",19:"יט",20:"כ",
       21:"כא",22:"כב",23:"כג",24:"כד",25:"כה",26:"כו",27:"כז",28:"כח",29:"כט",30:"ל"}
    return d.get(number)

def heb_weekday_names(number):
    d={1:"ראשון",2:"שני",3:"שלישי",4:"רביעי",5:"חמישי",6:"שישי",7:"שבת"}
    return d.get(number)
    ...
    while days_to_move != 0:
        ...
        if days_to_move > 0:
            ...
            if days_to_move <= remaining_days_in_month:
                ...
                current_day = 1
                current_month += 1
                if current_month > len(year_structure):
                    if days_to_move == 0:
                        current_month -= 1
...
def get_days_from_rosh_hashana(greg_year, greg_month, greg_day):
    ...
    if rosh_hashana_timestamp > current_timestamp:
        rosh_hashana_greg = get_geus_rosh_hashana_greg(current_year-1)
        rosh_hashana_year, rosh_hashana_month, rosh_hashana_day = rosh_hashana_greg
        rosh_hashana_timestamp = get_mktime_date_only(rosh_hashana_year, rosh_hashana_month, rosh_hashana_day)
    next_rosh_hashana_greg = get_geus_rosh_hashana_greg(rosh_hashana_year+1)
    ...
    rosh_hashana_heb_year_int = rosh_hashana_year + 3761
